...
export default function Footer() {
  const legalPages = [
    ...
    { name: "Anugrah Homes", href: "/anugrahhomes" },
    { name: "Brij Brinda", href: "https://brijvrindafarms.com/" },
    { name: "The Club Farm", href: "/the-club-farm" },
    { name: "SkyLine Aero Homes", href: "/skyline-aero-homes" },
   
    { name: "Noida International Airport", href: "/noida-international-airport" },
    ...
    { name: "Site Visit", href: "/book-site-visit" },
    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="border-t border-gray-700 bg-gray-800/50">
        <div className="max-w-7xl  mx-auto px-4 sm:px-6 lg:px-12 py-1">
          ...
          <div className=" rounded-lg pb-3 pt-5 md:pt-0 ">
