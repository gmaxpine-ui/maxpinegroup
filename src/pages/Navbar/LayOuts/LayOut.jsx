...
const LayOut = () => {
  ...
  const layout = "/downloads/BVL-New.png"; // replace with your image path
      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white shadow rounded-xl p-6">
            ...
            <Link to={"/projects/brij_vrinda/layout/blogs"}>
          ...
          <div className="mt-8 bg-gradient-to-br from-[#20ae9b] to-[#0d8a79] rounded-lg p-6 text-white">
            ...
            <Link to="/projects/brij_vrinda/layout/contact-us">
