...
import price1 from "../../../assets/skyline/SH Price List.png";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 text-sm text-gray-500">
        ...
        <span className="cursor-pointer hover:text-[#20ae9b]">SkyLine Aero Homes</span> &gt;{" "}
      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white shadow rounded-xl p-4 relative">
          ...
          <div className="mt-4 flex justify-center md:px-10">
            <a
              href={price1}
              download
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white shadow rounded-xl p-6">
            ...
            <Link to="/projects/skyline/pricelist/blogs">
          ...
          <div className="mt-8 bg-gradient-to-br from-[#20ae9b] to-[#0d8a79] rounded-lg p-6 text-white">
            ...
            <Link to="/projects/skyline/pricelist/contact-us">
