...
import pdf from "../assets/Brij.V.Development/12.jpg"
...
export default function BrijVrinda() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#20ae9b] to-[#0b8070] text-white">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-7 gap-2 md:px-20">
          {images.map((img, idx) => (
            <button
              ...
              className={`aspect-video rounded overflow-hidden ${mainImage === idx ? "ring-2 ring-[#20ae9b]" : ""
                }`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-[#20ae9b] pb-2 inline-block">
                Overview
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                <div className="bg-gradient-to-br from-[#20ae9b] to-[#109886] text-white p-6 rounded-lg text-center">
                ...
                <div className="bg-gradient-to-br from-[#20ae9b] to-[#107668] text-white p-6 rounded-lg text-center">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <ul className="space-y-3">
                {benefits.map((benefit, idx) => (
                  ...
                  >
                    <CheckCircle className="w-5 h-5 text-[#20ae9b] flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-6">
                {features.map((feature, idx) => (
                  ...
                  >
                    <CheckCircle className="w-5 h-5 text-[#20ae9b] flex-shrink-0" />
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-md p-6 sticky top-6">
              <h3 className="text-2xl font-bold text-[#20ae9b] mb-6">
                Property Details
              </h3>
              <div className="space-y-4">
                <div className="border-b border-gray-200 pb-3">
                  <p className="text-[#20ae9b] font-semibold mb-1">
                    Property Size
                  </p>
                ...
                <div className="pb-3">
                  <p className="text-[#20ae9b] font-semibold mb-1 flex items-center gap-2">
              ...
              <div className="space-y-3 mt-6">
                <button className="w-full bg-gradient-to-r from-[#20ae9b] to-[#128d7c] text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center gap-2 hover:shadow-lg transition-shadow">
                  <Phone className="w-5 h-5" />
                <Link to="/projects/brij_vrinda/contact-us">
                  Contact Us
                </Link>
                </button>
                <button className="w-full bg-gradient-to-r from-[#20ae9b] to-[#0c7466] text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center gap-2 hover:shadow-lg transition-shadow">
                  <Download className="w-5 h-5" />
                  <a
                    href={pdf}
                    download
                    className="w-full block text-center bg-gradient-to-r from-[#20ae9b] to-[#0e7f70] text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transition-shadow"
                  >
                    Download Brochure
                  </a>
