    ...
    <section className="py-16 px-6 md:px-16 lg:px-32 bg-white">
      <div className="grid  grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative   lg:h-[70vh]">
          {/* <div className="absolute -top-6 -left-6 w-60 h-6 bg-[#20ae9b] opacity-30"></div> */}
          <img
            src={img1}
            effect="blur"
            alt="Building"
          ...
          />
          {/* Badge */}
          <div className="absolute bottom-1 -left-10 bg-[#20ae9b] px-6 py-4 text-white font-medium shadow-lg">
        ...
        <div className="  ">
          ...
          <Link to="/about-us">
          <button className="bg-[#20ae9b] text-white font-medium px-8 py-3 rounded-full shadow hover:bg-[#226a61] transition">
            Read More...
          </button>
          </Link>
        </div>
