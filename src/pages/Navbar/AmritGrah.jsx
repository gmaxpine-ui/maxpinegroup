              ...
              {amenities.length > INITIAL_AMENITIES && (
                <div className="text-center mt-6">
                  <button
                    ...
                    className="bg-[#20ae9b] hover:bg-[#2c8579] text-white font-semibold px-4 md:px-8 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
                  >
                    {showAllAmenities 
                      ? "Show Less Features" 
              ...
              {reviews.length > INITIAL_REVIEWS && (
                <div className="text-center mt-6">
                  <button
                    ...
                    className="bg-[#20ae9b] hover:bg-[#298075] text-white font-semibold px-4 md:px-8 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
                  >
                    {showAllReviews 
                      ? "Show Less Reviews" 
            ...
            <div className="sticky top-6 space-y-6">
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">Amrit Garh Tour Form</h3>
